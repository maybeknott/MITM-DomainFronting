...
رفع مشکلات راه‌اندازی و اجرای محلی Xray-Cooperative-Overlay بر اساس نشانه‌های خطا. تمامی مراحل **روی رایانه شما** انجام می‌شوند و هیچ داده‌ای ارسال نگردیده یا تنظیمات سیستم بدون اجازه شما تغییر نمی‌کند.
